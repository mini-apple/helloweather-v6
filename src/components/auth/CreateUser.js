  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box>
            회원가입 조건은 헬로웨더의 현재멤버, 이전멤버입니다. 활동학기는
            2009년 이후부터 설정되어있으며 활동학기에 따라 멤버가 그룹핑됩니다.
          </Box>
          <Box>
            이 애플리케이션은 최소한의 정보저장으로 적은 관리를 통해
            지속가능하게 운영되기를 지향합니다. DB에 저장되는 회원정보는
            비밀번호를 제외한 최초 회원가입시 입력하는 모든 정보입니다.
          </Box>
        </Box>
      </Popover>
    </>
